...
public class MyAttendantInvitesFragment extends Fragment {
    ...
    public MyAttendantInvitesFragment(ProfileFragment profileFragment, ViewPager viewPager, NestedScrollView nestedScrollView,ProgressBar progressBar) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_my_attendant_invites,container,false);
        ...
        recyclerView = view.findViewById(R.id.my_attendant_invites_recycler_view);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter = new ProfileRecyclerAdapter(invites,profileFragment.getContext(),firebaseFirestore,firebaseAuth,fragmentTransaction,profileFragment,null,this);
    ...
    public void getDataFromFirestore() {
        ...
        listenerRegistration = documentReference.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                invites.clear();
                final ArrayList<String> instantInviteUids = (ArrayList<String>) documentSnapshot.get("attendantInstantInviteUids");
                final ArrayList<String> plannedInviteUids = (ArrayList<String>) documentSnapshot.get("attendantPlannedInviteUids");
                final ArrayList<String> eventUids = (ArrayList<String>) documentSnapshot.get("attendantEventUids");
                ...
                if (total > 0) {
                    ...
                    System.out.println("140 " + total + " " + initialViewPagerHeight + " " + initialScrollViewHeight);
                }
